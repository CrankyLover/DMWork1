...
if __name__ == "__main__" :
    ...
    file_list = ["10G_data_new/part-00000.parquet",
                 "10G_data_new/part-00001.parquet",
                 "10G_data_new/part-00002.parquet",
                 "10G_data_new/part-00003.parquet",
                 "10G_data_new/part-00004.parquet",
                 "10G_data_new/part-00005.parquet",
                 "10G_data_new/part-00006.parquet",
                 "10G_data_new/part-00007.parquet"]
    ...
    with open("country_frequency_dict.json", "w", encoding="utf-8") as f:
        json.dump(country_frequency_dict, f, indent=4)

    with open("email_frequency_dict.json", "w", encoding="utf-8") as f:
        json.dump(email_frequency_dict, f, indent=4)

    with open("country_email_dict.json", "w", encoding="utf-8") as f:
        json.dump(country_email_dict, f, indent=4)

    with open("country_income_dict.json", "w", encoding="utf-8") as f:
        json.dump(country_income_dict, f, indent=4)

    with open("item_category_dict.json", "w", encoding="utf-8") as f:
        json.dump(item_category_dict, f, indent=4)
    
    with open("category_freq.json", "w", encoding="utf-8") as f:
